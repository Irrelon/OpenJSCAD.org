...
const { setUpEditor, putSourceInEditor, getSourceFromEditor } = require('./editor');
...
const setCode = (code) => {
  putSourceInEditor(gEditor, code, "FunctionWorks.js");
  gProcessor.setJsCad(code, "FunctionWorks.js", window.location.origin + window.location.pathname);
};
